...
function Hero() {
  return (
    <>
    <section className='bg-black px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row  md:items-center 
    py-[50px]'>
        {/* Heading */}
  ...
  <button className='bg-[#FF9F0D] text-white w-[100px] h-[30px] md:w-[190px] md:h-[60px] rounded-[40px] mt-[32px] hover:bg-yellow-800'>
    See More
      ...
      <div className="mt-[50px] md:mt-0 ">
        <Image src="/hero.jfif" alt="Hero Image" className="" width={660} height={330} />
        <div className="flex flex-col md:flex-row mt-[16px] md:mt-[0]">
          <Image src="/hero2.jfif" alt="Hero Image" width={336} height={194} className="mr-[16px] pt-[20px]" />
          <Image src="/hero3.jfif" alt="Hero Image" width={336} height={536} className="pt-[40px]" />
        </div>
      </div>
    </section>
    <FoodCategory/>
